...
--------
- ZAM is an interpreted language written in Python than transpiled to pure c and then coverted into Executable.
- ZAM is great platform to begin with programming.
- It doesnt require indentations or braces.
...
- ZAM has multidemisional Arrays which are very great for calculations.
- Also you can perform mathematical operations on arrays.
- ZAM has 3 Logical operators which are ZAND (Logical AND), ZOR (Logical OR), ZOT (Logical NOT)
- ZAM has 7 different Types of Looping Statements.
- ZAM has 16 keywords in total here are those 'ZAM', 'ZAND', 'ZOR', 'ZOT', 'ZHEN', 'ZIF', 'ZELIF', 'ZELSE', 'ZOOP', 'ZO', 'ZEP', 'ZILE', 'ZUNC', 'ZEND', 'ZETURN', 'ZONTINUE', 'ZEREAK'
- ZAM can automatically differentiate between floats, integer, doubles, strings, arrays, etc
- ZAM has builtin support for boolean values and True and False.
- In ZAM you can add numbers into strings
- With ZUNC keyword you can create your functions in ZAM
- The zirint function in ZAM is to print or display sting/array/numbers on console
- The zirint_ret function can print and return function value.
